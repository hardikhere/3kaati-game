...
class JsonRpc2RpcMessageCodec {
    ...
    fromJson(message) {
        ...
        if (typeof message.method === 'string') {
            ...
            const value = data === undefined ? undefined : new Value_1.Value(request.params, undefined);
        ...
        if (message.result !== undefined) {
            ...
            const value = data === undefined ? undefined : new Value_1.Value(response.result, undefined);
            return new msg.ResponseCompleteMessage(response.id, value);
        }
        if (message.error !== undefined) {
            const response = message;
            const value = new Value_1.Value(response.error.data, undefined);
            if (typeof response.id !== 'number')
                throw error_1.RpcError.invalidRequest();
