    ...
    constructor(params) {
        ...
        this.channel.open$.pipe((0, operators_1.filter)((open) => open)).subscribe(() => {
            ...
            const duplex = new RpcDuplex_1.RpcDuplex({
                client: new StreamingRpcClient_1.StreamingRpcClient(Object.assign(Object.assign({}, (params.client || {})), { send: (messages) => {
                        const encoded = codec.encode(messages);
                        this.channel.send$(encoded).subscribe();
                    } })),
                server: new RpcMessageStreamProcessor_1.RpcMessageStreamProcessor(Object.assign(Object.assign({}, (params.server || {
